...
const Footer: React.FC<{ locale: string }> = ({ locale }) => {
    ...
    return (
        <footer className="px-4 divide-y bg-primary dark:bg-gray-800 dark:text-gray-100">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start pb-4">
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-1 content-2">
                            <li>
                                <a rel="noopener noreferrer" href="#">Ismatech Business School</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Ismatech Business Management</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Ismatech Projects Management</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Ismatech Events Management</a>
                            </li>
                        </ul>
                    </div>
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-1 content-2">
                            <li>
                                <a rel="noopener noreferrer" href="#">Management & Strategies Des Entreprises</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Gestions Des Resources Humaines</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Marketing Et Veille Strategique</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Comptabilité Informatisée De Gestion</a>
                            </li>
                        </ul>
                    </div>
                    <div className="space-y-3">
